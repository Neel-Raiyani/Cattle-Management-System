...
class AdultAlertScreen extends StatefulWidget {
  const AdultAlertScreen({super.key});

  @override
  State<AdultAlertScreen> createState() => _AdultAlertScreenState();
}

class _AdultAlertScreenState extends State<AdultAlertScreen> {
  ...
  List<Cattle> _getAdultCandidates(List<Cattle> allCattle) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CattleBloc, CattleState>(
        builder: (context, state) {
          ...
          final animals = _getAdultCandidates(cattleList);
              ...
              Expanded(
                child: animals.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (ctx, i) =>
                            _AdultAlertCard(animal: animals[i]),
                      ),
              ),
            ],
          );
...
class _AdultAlertCard extends StatelessWidget {
  final Cattle animal;
  const _AdultAlertCard({required this.animal});
